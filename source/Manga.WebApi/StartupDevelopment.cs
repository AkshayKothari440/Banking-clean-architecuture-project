...

{
    public sealed class StartupDevelopment
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddIdentity<IdentityUser, IdentityRole>() //Add by ak
        .AddEntityFrameworkStores<MangaContext>();  //Add by ak
        ...
        private void AddMangaCore(IServiceCollection services)
        {
            ...
            //services.AddScoped<Manga.Application.Boundaries.CloseAccount.IOutputHandler, Manga.WebApi.UseCases.CloseAccount.Presenter>();
            //services.AddScoped<Manga.Application.Boundaries.Deposit.IOutputHandler, Manga.WebApi.UseCases.Deposit.Presenter>();
            //services.AddScoped<Manga.Application.Boundaries.GetAccountDetails.IOutputHandler, Manga.WebApi.UseCases.GetAccountDetails.Presenter>();
            //services.AddScoped<Manga.Application.Boundaries.GetCustomerDetails.IOutputHandler, Manga.WebApi.UseCases.GetCustomerDetails.Presenter>();
            //services.AddScoped<Manga.Application.Boundaries.Register.IOutputHandler, Manga.WebApi.UseCases.Register.Presenter>();
            //services.AddScoped<Manga.Application.Boundaries.Withdraw.IOutputHandler, Manga.WebApi.UseCases.Withdraw.Presenter>();
        ...
        public void Configure(IApplicationBuilder app, IHostingEnvironment env)
        {
            ...
            UseSwagger(app);
            app.UseAuthentication();  // Add by Ak
